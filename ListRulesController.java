...
public class ListRulesController implements Initializable {
        ...
        try {
            while (result.next()) {
                ...
                */
                ...
                list.add(new Rule(eventSubject, termIDAux, daysFromStart));
               
            }
        } catch (SQLException ex) {
            System.out.println("Exception listrules 1 controller");
        }
    ...
    private void editRuleEvent() {
        ...
        if (!tableView.getSelectionModel().isEmpty()){
            ...
            try {
               ...
               editRuleLoader.setLocation(getClass().getResource("/gui/edit_rule.fxml"));
               ...
               stage.show();
                ...
                System.out.println("Exception listrules 2 controller");
            }
        }
    }
    ...
    public boolean createEventFromRule(String evtDescription, int auxTermID, String auxDaysFromStart, String auxCalName) {
        ...
        String insertEventQuery = "INSERT INTO DEALS VALUES ("
                                + "'" + evtDescription + "', "
                                + "'" + newEventDate + "', "
                                + auxTermID + ", "
                                + "'" + auxCalName + "'"
    ...
    public String getNewEventDate (String auxTermStartDate, String auxDays) {
        ...
        try {
            ...
            System.out.println("Exception listrules 3 controller");
        }
