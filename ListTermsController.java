...
public class ListTermsController implements Initializable {
    ...
    private void editTermEvent() {
        ...
        if (!tableView.getSelectionModel().isEmpty()){
            ...
            try {
               ...
               editTermLoader.setLocation(getClass().getResource("/gui/edit_term.fxml"));
               ...
               stage.show();
                ...
                System.out.println("Exception listterms 1 controller");
            }
        }
    }
    ...
    public void loadData(){
        ...
        try {
            ...
            System.out.println("Exception listterms 2 controller");
        }
