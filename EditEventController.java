...
public class EditEventController implements Initializable {
    ...
    void autofillDatePicker() {
        ...
        try {
             ...
             System.out.println("Exception editevent 1 controller");
        }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            System.out.println("Exception editevent 2 controller");
        }   
    ...
    public void updateEvent(){
        ...
        try {
            ...
            System.out.println("Exception editevent 3 controller");
        }    
        ...
        String updateEventQuery = "UPDATE DEALS"
                                + " SET "
                                + "EventDescription='" + newEventSubject + "', "
                                + "EventDate='" + newCalendarDate + "', "
                                + "TermID=" + newTerm
                                + " WHERE "
                                + "DEALS.EventDescription='" + descript + "' AND "
                                + "DEALS.EventDate='" + auxDate + "' AND "
                                + "DEALS.TermID=" + termID + " AND "
                                + "DEALS.CalendarName='" + calName + "' ";
    ...
    public void deleteEvent() {
        ...
        try {
            ...
            System.out.println("Exception editevent 4 controller");
        }
        
        //Query that will delete the selected event
        String deleteEventQuery = "DELETE FROM DEALS "
                                + "WHERE "
                                + "DEALS.EventDescription='" + descript + "' AND "
                                + "DEALS.EventDate='" + auxDate + "' AND "
                                + "DEALS.TermID=" + termID + " AND "
