...
public class Excel {
     public static void main(String[] args) throws InterruptedException {
            ...
            try {        
           	wworkbook = Workbook.createWorkbook(new File("C:\\Users\\Amine\\Documents\\Python Scripts\\pidev\\Taland\\listusers.xls"));
				...
				ResultSet rs=null;
	 			...
	 			String query="SELECT id,firstname,lastname,email,username FROM `fos_user`;";
